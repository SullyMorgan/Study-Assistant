...
const styles = StyleSheet.create({
  ...
  deadlineCard: { backgroundColor: '#fffdfa', width: 220, borderRadius: 12, padding: 15, marginRight: 15, borderWidth: 0, borderColor: '#62119f', borderLeftWidth: 5 },
  ...
  emptyCard: { backgroundColor: '#fffdfa', borderRadius: 12, padding: 20, alignItems: 'center', borderWidth: 0, borderColor: '#62119f', borderStyle: 'dashed' },
  emptyText: { color: '#57534e', marginTop: 8, fontWeight: '500', fontSize: 14 },

  taskItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fffdfa', padding: 15, borderRadius: 12, marginBottom: 10, borderWidth: 0, borderColor: '#62119f' },
